...
var rob = function (nums) {
    ...
    // dp starts from 0th number to end-1 of array, to avoid cycle last number cannot be used
    let case1 = dphelper(0, nums.length - 2)
    // dp starts from 1st number to end of array, to avoid cycle fisrt number cannot be used when last is included
